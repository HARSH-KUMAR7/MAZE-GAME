 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(5,160,"  NITTE MEENAKSHI INSTITUTE OF TECHNOLOGY");
	glColor3f(1,1,1);
	output(10.0,150,"	DEPARTMENT OF INFORMATION SCIENCE AND ENGINEERING");
	glColor3f(1,0,1);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"HARSH KUMAR , ABHINAV PRAKASH , ANJANI SAURAV AND SUYASH AGARWAL");
	...
	glColor3f(1,0,0);
	output(70,40,"Mr. CHANDRASHEKAR B N");
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
	//drawstring(72,30,"(B.E.)",GLUT_BITMAP_HELVETICA_12);

	//output(70,20,"Lecturer,Dept. of ISE");
	glFlush();
 ...
 void frontscreen(void)
{
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"SENSEI HARSH KUMAR  ,  ASSAMEE AATNAKWAADI  AND  ANJANI SOURAV");
